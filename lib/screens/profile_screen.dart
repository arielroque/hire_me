...
class ProfileUser extends StatefulWidget {
  ...
  const ProfileUser({Key key, this.profile, this.index}) : super(key: key);
      ...
      return Padding(
        ...
        child: ClipPath(
          ...
          child: Container(
            ...
            color: Utils.getRandomColor(widget.index)
          ),
        ),
      );
    }
            ...
            children: <Widget>[
              Padding(
                ...
                child: Text(
                  ...
                  style: TextStyle(
                      fontFamily: 'Viga', fontSize: 20.0, color: Colors.white),
                ),
              )
            ],
          ),
